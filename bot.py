...
import Client
import traceback
bot_token = '5000923231:AAEWxzJhQI0_nCV7Bp6hsFkyKzsmyKqPgPw'

api_id = 19058782
api_hash = '4464bb7b0de21ac3a0efa34816cde153'

links =[]

#Users_Data=[['testray11'],['testray12'],['testray13'],['testray14'],['testray15'],['testray16'],['testray17'],['testray18']]
Users_Data=['alejandra','ID DE LA PAGINA']
...
async def upload_to_moodle(f,msg):
            ...
            try:
                ...
                moodle = Client.Client(rand_user[0],'Alejandro@2018')
                loged = moodle.login()
                if loged == True:
